import type { ColumnDef, SortState, TaskBoardNode } from "../_types/board.types";

function sortableValue(node: TaskBoardNode, column_id: string, columns: ColumnDef[]): string | number {
...
export function applySort<T extends TaskBoardNode>(nodes: T[], sort: SortState | null, scope_key: string, columns: ColumnDef[]): T[] {
