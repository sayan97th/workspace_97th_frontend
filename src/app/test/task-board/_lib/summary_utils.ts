import type { ColumnDef, StatusDef, TaskBoardItem } from "../_types/board.types";
...
function numberValueOf(item: TaskBoardItem, column_id: string): number {
...
export function summaryForColumn(items: TaskBoardItem[], column: ColumnDef, status_defs: StatusDef[]): ColumnSummary {
