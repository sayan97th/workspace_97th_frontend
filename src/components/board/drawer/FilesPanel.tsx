...
const FilesPanel: React.FC<FilesPanelProps> = ({ item_title }) => (
  <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-5 py-6 text-center text-shell-text-faint">
    ...
    <button
      type="button"
      className="mt-4 rounded-[9px] border border-shell-border-strong bg-shell-panel-alt px-5 py-2.5 text-[13px] font-semibold text-shell-text hover:border-[#00c875]"
    >
      Upload files
    </button>
  </div>
