 ...
 */
function KanbanItemDrawer<TRow>({
  drawer,
  title,
  onRenameTitle,
  is_done,
  ...
  return (
    <>
      <div onClick={drawer.close} className="fixed inset-0 z-[400]" style={{ background: "rgba(10,23,23,0.32)" }} />
      <div
        className="fixed bottom-0 right-0 top-0 z-[401] flex w-[440px] max-w-[94vw] flex-col"
        style={{ background: "#FFFFFF", boxShadow: "-8px 0 32px rgba(10,23,23,0.14)" }}
      >
        {/* Header */}
        <div
