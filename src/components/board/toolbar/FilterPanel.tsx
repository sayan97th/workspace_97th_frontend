...
function FilterPanel<TRow>({ toolbar }: FilterPanelProps<TRow>) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-boardtree-border bg-boardtree-surface shadow-2xl shadow-black/40">
      <div className="flex items-center gap-3 px-5 pb-3.5 pt-4">
        ...
        <button
          type="button"
          className="rounded-lg border border-boardtree-border px-3.5 py-1.5 text-[13px] font-semibold text-boardtree-text-secondary hover:border-boardtree-text-faint"
        >
          Save as new view
        </button>
      </div>
      ...
      <div className="flex justify-end border-t border-boardtree-border-soft bg-boardtree-hover px-5 py-3">
        <button
          type="button"
