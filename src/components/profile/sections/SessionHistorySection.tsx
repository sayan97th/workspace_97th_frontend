...
const SessionHistorySection: React.FC<SessionHistorySectionProps> = ({ profile }) => (
  <div>
    ...
    <p className="mb-[22px] text-[13.5px] text-shell-text-muted">{profile.session_rows.length} Sessions</p>
    ...
    <div className="scrollnice max-h-[440px] overflow-y-auto">
      {profile.session_rows.map((row) => (
        ...
        >
          ...
          <span className="truncate text-[13px] text-shell-text-muted">{row.location}</span>
